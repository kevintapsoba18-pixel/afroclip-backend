...
// démarrage. Deux façons de les fournir :
// - YTDLP_COOKIES : colle directement le contenu du fichier cookies.txt
//   (format Netscape) tel quel — le plus simple depuis un mobile.
// - YTDLP_COOKIES_B64 : le même contenu encodé en base64 (utile si la
//   variable d'environnement a du mal avec les sauts de ligne).
...
if (process.env.YTDLP_COOKIES) {
  try {
    ...
    console.log('Cookies YouTube chargés depuis YTDLP_COOKIES (texte brut)');
  } catch (e) {
